...
pub fn chart() -> Chart {
    ...
    Chart::new()
        ...
        .parallel_axis(ParallelAxis::new().dim(3).name("PM10"))
        .parallel_axis(ParallelAxis::new().dim(4).name("CO"))
        .parallel_axis(ParallelAxis::new().dim(5).name("NO2"))
        .parallel_axis(ParallelAxis::new().dim(6).name("SO2"))
        .parallel_axis(
            ParallelAxis::new()
                .dim(7)
                .name("等级")
...
#[derive(Deserialize)]
struct Data {
    data_bj: Vec<Vec<CompositeValue>>,
    data_gz: Vec<Vec<CompositeValue>>,
    data_sh: Vec<Vec<CompositeValue>>,
}
